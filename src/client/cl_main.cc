...
=======================
*/
static trans_t* LookupTrans( char *original, char *translated[MAX_LANGUAGES], bool isLoading ) {
...
=======================
*/
bool CL_CheckTranslationString( char *original, char *translated ) {
