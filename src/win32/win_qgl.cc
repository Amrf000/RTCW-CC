...
bool QGL_Init( const char *dllname ) {
	...
	qglBindTexture               = dllBindTexture = (void(__stdcall*)(GLenum target, GLuint texture))GPA( "glBindTexture" );
	qglBitmap                    = dllBitmap = (void(__stdcall*)(GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig, GLfloat xmove, GLfloat ymove, const GLubyte * bitmap))GPA( "glBitmap" );
	qglBlendFunc                 = dllBlendFunc = (void(__stdcall*)(GLenum sfactor, GLenum dfactor))GPA( "glBlendFunc" );
	qglCallList                  = dllCallList = (void(__stdcall*)(GLuint list))GPA( "glCallList" );
	qglCallLists                 = dllCallLists = (void(__stdcall*)(GLsizei n, GLenum type, const GLvoid * lists))GPA( "glCallLists" );
	...
	qglClearColor                = dllClearColor = (void(__stdcall*)(GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha))GPA( "glClearColor" );
	...
	qglClearStencil              = dllClearStencil = (void(__stdcall*)(GLint s))GPA( "glClearStencil" );
	...
	qglColor3ui                  = dllColor3ui = (void(__stdcall*)(GLuint red, GLuint green, GLuint blue))GPA( "glColor3ui" );
	qglColor3uiv                 = dllColor3uiv = (void(__stdcall*)(const GLuint * v))GPA( "glColor3uiv" );
	qglColor3us                  = dllColor3us = (void(__stdcall*)(GLushort red, GLushort green, GLushort blue))GPA( "glColor3us" );
	qglColor3usv                 = dllColor3usv = (void(__stdcall*)(const GLushort * v))GPA( "glColor3usv" );
	qglColor4b                   = dllColor4b = (void(__stdcall*)(GLbyte red, GLbyte green, GLbyte blue, GLbyte alpha))GPA( "glColor4b" );
	qglColor4bv                  = dllColor4bv = (void(__stdcall*)(const GLbyte * v))GPA( "glColor4bv" );
	qglColor4d                   = dllColor4d = (void(__stdcall*)(GLdouble red, GLdouble green, GLdouble blue, GLdouble alpha))GPA( "glColor4d" );
	qglColor4dv                  = dllColor4dv = (void(__stdcall*)(const GLdouble * v))GPA( "glColor4dv" );
	qglColor4f                   = dllColor4f = (void(__stdcall*)(GLfloat, GLfloat, GLfloat, GLfloat))GPA( "glColor4f" );
	qglColor4fv                  = dllColor4fv = (void(__stdcall*)(const GLfloat * v))GPA( "glColor4fv" );
	qglColor4i                   = dllColor4i = (void(__stdcall*)(GLint red, GLint green, GLint blue, GLint alpha))GPA( "glColor4i" );
	qglColor4iv                  = dllColor4iv = (void(__stdcall*)(const GLint * v))GPA( "glColor4iv" );
	qglColor4s                   = dllColor4s = (void(__stdcall*)(GLshort red, GLshort green, GLshort blue, GLshort alpha))GPA( "glColor4s" );
	qglColor4sv                  = dllColor4sv = (void (__stdcall *)(const GLshort *v))GPA( "glColor4sv" );
	qglColor4ub                  = dllColor4ub = (void (__stdcall *)(GLubyte red, GLubyte green, GLubyte blue, GLubyte alpha))GPA( "glColor4ub" );
	qglColor4ubv                 = dllColor4ubv = (void (__stdcall *)(const GLubyte *v))GPA( "glColor4ubv" );
	qglColor4ui                  = dllColor4ui = (void (__stdcall *)(GLuint red, GLuint green, GLuint blue, GLuint alpha))GPA( "glColor4ui" );
	qglColor4uiv                 = dllColor4uiv = (void (__stdcall *)(const GLuint *v))GPA( "glColor4uiv" );
	qglColor4us                  = dllColor4us = (void (__stdcall *)(GLushort red, GLushort green, GLushort blue, GLushort alpha))GPA( "glColor4us" );
	qglColor4usv                 = dllColor4usv = (void (__stdcall *)(const GLushort *v))GPA( "glColor4usv" );
	qglColorMask                 = dllColorMask = (void (__stdcall *)(GLboolean red, GLboolean green, GLboolean blue, GLboolean alpha))GPA( "glColorMask" );
	qglColorMaterial             = dllColorMaterial = (void (__stdcall *)(GLenum face, GLenum mode))GPA( "glColorMaterial" );
	qglColorPointer              = dllColorPointer = (void (__stdcall *)(GLint size, GLenum type, GLsizei stride, const GLvoid *pointer))GPA( "glColorPointer" );
	qglCopyPixels                = dllCopyPixels = (void (__stdcall *)(GLint x, GLint y, GLsizei width, GLsizei height, GLenum type))GPA( "glCopyPixels" );
	qglCopyTexImage1D            = dllCopyTexImage1D = (void (__stdcall *)(GLenum target, GLint level, GLenum internalFormat, GLint x, GLint y, GLsizei width, GLint border))GPA( "glCopyTexImage1D" );
	qglCopyTexImage2D            = dllCopyTexImage2D = (void(__stdcall*)(GLenum target, GLint level, GLenum internalFormat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border))GPA( "glCopyTexImage2D" );
	qglCopyTexSubImage1D         = dllCopyTexSubImage1D = (void (__stdcall *)(GLenum target, GLint level, GLint xoffset, GLint x, GLint y, GLsizei width))GPA( "glCopyTexSubImage1D" );
	qglCopyTexSubImage2D         = dllCopyTexSubImage2D = (void (__stdcall *)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height))GPA( "glCopyTexSubImage2D" );
	qglCullFace                  = dllCullFace = (void(__stdcall*)(GLenum))GPA( "glCullFace" );
	qglDeleteLists               = dllDeleteLists = (void (__stdcall *)(GLuint list, GLsizei range))GPA( "glDeleteLists" );
	qglDeleteTextures            = dllDeleteTextures = (void (__stdcall *)(GLsizei n, const GLuint *textures))GPA( "glDeleteTextures" );
	...
	qglDepthRange                = dllDepthRange = (void (__stdcall *)(GLclampd zNear, GLclampd zFar))GPA( "glDepthRange" );
	...
	qglDrawArrays                = dllDrawArrays = (void (__stdcall *)(GLenum mode, GLint first, GLsizei count))GPA( "glDrawArrays" );
	qglDrawBuffer                = dllDrawBuffer = (void(__stdcall*)(GLenum mode))GPA( "glDrawBuffer" );
	qglDrawElements              = dllDrawElements = (void(__stdcall*)(GLenum mode, GLsizei count, GLenum type, const GLvoid * indices))GPA( "glDrawElements" );
	qglDrawPixels                = dllDrawPixels = (void(__stdcall*)(GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid * pixels))GPA( "glDrawPixels" );
	qglEdgeFlag                  = dllEdgeFlag = (void(__stdcall*)(GLboolean))GPA( "glEdgeFlag" );
	qglEdgeFlagPointer           = dllEdgeFlagPointer = (void(__stdcall*)(GLsizei stride, const GLvoid * pointer))GPA( "glEdgeFlagPointer" );
	qglEdgeFlagv                 = dllEdgeFlagv = (void(__stdcall*)(const GLboolean * flag))GPA( "glEdgeFlagv" );
	...
	qglEvalCoord1d               =  dllEvalCoord1d               = (void (__stdcall *)(GLdouble u))GPA( "glEvalCoord1d" );
	qglEvalCoord1dv              =  dllEvalCoord1dv              = (void (__stdcall *)(const GLdouble *u))GPA( "glEvalCoord1dv" );
	qglEvalCoord1f               =  dllEvalCoord1f               = (void(__stdcall*)(GLfloat))GPA( "glEvalCoord1f" );
	qglEvalCoord1fv              =  dllEvalCoord1fv              = (void (__stdcall *)(const GLfloat * u))GPA( "glEvalCoord1fv" );
	qglEvalCoord2d               =  dllEvalCoord2d               = (void (__stdcall *)(GLdouble u, GLdouble v))GPA( "glEvalCoord2d" );
	qglEvalCoord2dv              =  dllEvalCoord2dv              = (void (__stdcall *)(const GLdouble* u))GPA( "glEvalCoord2dv" );
	qglEvalCoord2f               =  dllEvalCoord2f               = (void (__stdcall *)(GLfloat u, GLfloat v))GPA( "glEvalCoord2f" );
	qglEvalCoord2fv              =  dllEvalCoord2fv              = (void (__stdcall *)(const GLfloat *u))GPA( "glEvalCoord2fv" );
	qglEvalMesh1                 =  dllEvalMesh1                 = (void(__stdcall*)(GLenum mode, GLint i1, GLint i2))GPA( "glEvalMesh1" );
	qglEvalMesh2                 =  dllEvalMesh2                 = (void(__stdcall*)(GLenum, GLint, GLint, GLint, GLint))GPA( "glEvalMesh2" );
	qglEvalPoint1                =  dllEvalPoint1                = (void(__stdcall*)(GLint i))GPA( "glEvalPoint1" );
	qglEvalPoint2                =  dllEvalPoint2                = (void(__stdcall*)(GLint i, GLint j))GPA( "glEvalPoint2" );
	qglFeedbackBuffer            =  dllFeedbackBuffer            = (void (__stdcall *)(GLsizei size, GLenum type, GLfloat *buffer))GPA( "glFeedbackBuffer" );
	qglFinish                    =  dllFinish                    = (void(__stdcall*)(void))GPA( "glFinish" );
	qglFlush                     =  dllFlush                     = (void(__stdcall*)(void))GPA( "glFlush" );
	qglFogf                      =  dllFogf                      = (void (__stdcall *)(GLenum pname, GLfloat param))GPA( "glFogf" );
	qglFogfv                     =  dllFogfv                     = (void (__stdcall *)(GLenum pname, const GLfloat *params))GPA( "glFogfv" );
	qglFogi                      =  dllFogi                      = (void (__stdcall *)(GLenum pname, GLint param))GPA( "glFogi" );
	qglFogiv                     =  dllFogiv                     = (void (__stdcall *)(GLenum pname, const GLint *params))GPA( "glFogiv" );
	qglFrontFace                 =  dllFrontFace                 = (void(__stdcall*)(GLenum))GPA( "glFrontFace" );
	qglFrustum                   =  dllFrustum                   = (void (__stdcall *)(GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble zNear, GLdouble zFar))GPA( "glFrustum" );
	qglGenLists                  =  dllGenLists                  = ( GLuint ( __stdcall * )(int) )GPA( "glGenLists" );
	qglGenTextures               =  dllGenTextures               = (void (__stdcall *)(GLsizei n, GLuint *textures))GPA( "glGenTextures" );
	qglGetBooleanv               =  dllGetBooleanv               = (void (__stdcall *)(GLenum pname, GLboolean *params))GPA( "glGetBooleanv" );
	qglGetClipPlane              =  dllGetClipPlane              = (void (__stdcall *)(GLenum plane, GLdouble *equation))GPA( "glGetClipPlane" );
	qglGetDoublev                =  dllGetDoublev                = (void (__stdcall *)(GLenum pname, GLdouble *params))GPA( "glGetDoublev" );
	qglGetError                  =  dllGetError                  = ( GLenum ( __stdcall * )(void) )GPA( "glGetError" );
	qglGetFloatv                 =  dllGetFloatv                 = (void (__stdcall *)(GLenum pname, GLfloat *params))GPA( "glGetFloatv" );
	qglGetIntegerv               =  dllGetIntegerv               = (void (__stdcall *)(GLenum pname, GLint *params))GPA( "glGetIntegerv" );
	qglGetLightfv                =  dllGetLightfv                = (void (__stdcall *)(GLenum light, GLenum pname, GLfloat *params))GPA( "glGetLightfv" );
	qglGetLightiv                =  dllGetLightiv                = (void (__stdcall *)(GLenum light, GLenum pname, GLint *params))GPA( "glGetLightiv" );
	qglGetMapdv                  =  dllGetMapdv                  = (void (__stdcall *)(GLenum target, GLenum query, GLdouble *v))GPA( "glGetMapdv" );
	qglGetMapfv                  =  dllGetMapfv                  = (void (__stdcall *)(GLenum target, GLenum query, GLfloat *v))GPA( "glGetMapfv" );
	qglGetMapiv                  =  dllGetMapiv                  = (void (__stdcall *)(GLenum target, GLenum query, GLint *v))GPA( "glGetMapiv" );
	qglGetMaterialfv             =  dllGetMaterialfv             = (void (__stdcall *)(GLenum face, GLenum pname, GLfloat *params))GPA( "glGetMaterialfv" );
	qglGetMaterialiv             =  dllGetMaterialiv             = (void (__stdcall *)(GLenum face, GLenum pname, GLint *params))GPA( "glGetMaterialiv" );
	qglGetPixelMapfv             =  dllGetPixelMapfv             = (void (__stdcall *)(GLenum map, GLfloat *values))GPA( "glGetPixelMapfv" );
	qglGetPixelMapuiv            =  dllGetPixelMapuiv            = (void (__stdcall *)(GLenum map, GLuint *values))GPA( "glGetPixelMapuiv" );
	qglGetPixelMapusv            =  dllGetPixelMapusv            = (void (__stdcall *)(GLenum map, GLushort *values))GPA( "glGetPixelMapusv" );
	qglGetPointerv               =  dllGetPointerv               = (void (__stdcall *)(GLenum pname, GLvoid **params))GPA( "glGetPointerv" );
	qglGetPolygonStipple         =  dllGetPolygonStipple         = (void (__stdcall *)(GLubyte *mask))GPA( "glGetPolygonStipple" );
	qglGetString                 =  dllGetString                 = (const GLubyte *(__stdcall *)(GLenum name))GPA( "glGetString" );
	qglGetTexEnvfv               =  dllGetTexEnvfv               = (void (__stdcall *)(GLenum target, GLenum pname, GLfloat *params))GPA( "glGetTexEnvfv" );
	qglGetTexEnviv               =  dllGetTexEnviv               = (void (__stdcall *)(GLenum target, GLenum pname, GLint *params))GPA( "glGetTexEnviv" );
	qglGetTexGendv               =  dllGetTexGendv               = (void (__stdcall *)(GLenum coord, GLenum pname, GLdouble *params))GPA( "glGetTexGendv" );
	qglGetTexGenfv               =  dllGetTexGenfv               = (void (__stdcall *)(GLenum coord, GLenum pname, GLfloat *params))GPA( "glGetTexGenfv" );
	qglGetTexGeniv               =  dllGetTexGeniv               = (void (__stdcall *)(GLenum coord, GLenum pname, GLint *params))GPA( "glGetTexGeniv" );
	qglGetTexImage               =  dllGetTexImage               = (void (__stdcall *)(GLenum target, GLint level, GLenum format, GLenum type, GLvoid *pixels))GPA( "glGetTexImage" );
	...
	qglIndexdv                   =  dllIndexdv                   = (void (__stdcall *)(const GLdouble *c))GPA( "glIndexdv" );
	qglIndexf                    =  dllIndexf                    = (void (__stdcall *)(GLfloat c))GPA( "glIndexf" );
	qglIndexfv                   =  dllIndexfv                   = (void (__stdcall *)(const GLfloat *c))GPA( "glIndexfv" );
	qglIndexi                    =  dllIndexi                    = (void (__stdcall *)(GLint c))GPA( "glIndexi" );
	qglIndexiv                   =  dllIndexiv                   = (void (__stdcall *)(const GLint *c))GPA( "glIndexiv" );
	qglIndexs                    =  dllIndexs                    = (void (__stdcall *)(GLshort c))GPA( "glIndexs" );
	qglIndexsv                   =  dllIndexsv                   = (void (__stdcall *)(const GLshort *c))GPA( "glIndexsv" );
	qglIndexub                   =  dllIndexub                   = (void (__stdcall *)(GLubyte c))GPA( "glIndexub" );
	qglIndexubv                  =  dllIndexubv                  = (void (__stdcall *)(const GLubyte *c))GPA( "glIndexubv" );
	qglInitNames                 =  dllInitNames                 = (void (__stdcall *)())GPA( "glInitNames" );
	qglInterleavedArrays         =  dllInterleavedArrays         = (void (__stdcall *)(GLenum format, GLsizei stride, const GLvoid *pointer))GPA( "glInterleavedArrays" );
	qglIsEnabled                 =  dllIsEnabled                 = (GLboolean(__stdcall*)(GLenum cap))GPA( "glIsEnabled" );
	qglIsList                    =  dllIsList                    = (GLboolean (__stdcall *)(GLuint list))GPA( "glIsList" );
	qglIsTexture                 =  dllIsTexture                 = (GLboolean (__stdcall *)(GLuint texture))GPA( "glIsTexture" );
	qglLightModelf               =  dllLightModelf               = (void (__stdcall *)(GLenum pname, GLfloat param))GPA( "glLightModelf" );
	qglLightModelfv              =  dllLightModelfv              = (void (__stdcall *)(GLenum pname, const GLfloat *params))GPA( "glLightModelfv" );
	qglLightModeli               =  dllLightModeli               = (void (__stdcall *)(GLenum pname, GLint param))GPA( "glLightModeli" );
	qglLightModeliv              =  dllLightModeliv              = (void (__stdcall *)(GLenum pname, const GLint *params))GPA( "glLightModeliv" );
	qglLightf                    =  dllLightf                    = (void (__stdcall *)(GLenum light, GLenum pname, GLfloat param))GPA( "glLightf" );
	qglLightfv                   =  dllLightfv                   = (void (__stdcall *)(GLenum light, GLenum pname, const GLfloat *params))GPA( "glLightfv" );
	qglLighti                    =  dllLighti                    = (void (__stdcall *)(GLenum light, GLenum pname, GLint param))GPA( "glLighti" );
	...
	qglListBase                  =  dllListBase                  = (void (__stdcall *)(GLuint base))GPA( "glListBase" );
	qglLoadIdentity              =  dllLoadIdentity              = (void (__stdcall *)())GPA( "glLoadIdentity" );
	qglLoadMatrixd               =  dllLoadMatrixd               = (void (__stdcall *)(const GLdouble *m))GPA( "glLoadMatrixd" );
	qglLoadMatrixf               =  dllLoadMatrixf               = (void (__stdcall *)(const GLfloat *m))GPA( "glLoadMatrixf" );
	qglLoadName                  =  dllLoadName                  = (void (__stdcall *)(GLuint name))GPA( "glLoadName" );
	qglLogicOp                   =  dllLogicOp                   = (void (__stdcall *)(GLenum opcode))GPA( "glLogicOp" );
	qglMap1d                     =  dllMap1d                     = (void (__stdcall *)(GLenum target, GLdouble u1, GLdouble u2, GLint stride, GLint order, const GLdouble *points))GPA( "glMap1d" );
	qglMap1f                     =  dllMap1f                     = (void (__stdcall *)(GLenum target, GLfloat u1, GLfloat u2, GLint stride, GLint order, const GLfloat *points))GPA( "glMap1f" );
	qglMap2d                     =  dllMap2d                     = (void (__stdcall *)(GLenum target, GLdouble u1, GLdouble u2, GLint ustride, GLint uorder, GLdouble v1, GLdouble v2, GLint vstride, GLint vorder, const GLdouble *points))GPA( "glMap2d" );
	qglMap2f                     =  dllMap2f                     = (void (__stdcall *)(GLenum target, GLfloat u1, GLfloat u2, GLint ustride, GLint uorder, GLfloat v1, GLfloat v2, GLint vstride, GLint vorder, const GLfloat *points))GPA( "glMap2f" );
	qglMapGrid1d                 =  dllMapGrid1d                 = (void (__stdcall *)(GLint un, GLdouble u1, GLdouble u2))GPA( "glMapGrid1d" );
	qglMapGrid1f                 =  dllMapGrid1f                 = (void(__stdcall*)(GLint, GLfloat, GLfloat))GPA( "glMapGrid1f" );
	qglMapGrid2d                 =  dllMapGrid2d                 = (void (__stdcall *)(GLint un, GLdouble u1, GLdouble u2, GLint vn, GLdouble v1, GLdouble v2))GPA( "glMapGrid2d" );
	qglMapGrid2f                 =  dllMapGrid2f                 = (void (__stdcall *)(GLint un, GLfloat u1, GLfloat u2, GLint vn, GLfloat v1, GLfloat v2))GPA( "glMapGrid2f" );
	qglMaterialf                 =  dllMaterialf                 = (void (__stdcall *)(GLenum face, GLenum pname, GLfloat param))GPA( "glMaterialf" );
	qglMaterialfv                =  dllMaterialfv                = (void (__stdcall *)(GLenum face, GLenum pname, const GLfloat *params))GPA( "glMaterialfv" );
	qglMateriali                 =  dllMateriali                 = (void (__stdcall *)(GLenum face, GLenum pname, GLint param))GPA( "glMateriali" );
	qglMaterialiv                =  dllMaterialiv                = (void (__stdcall *)(GLenum face, GLenum pname, const GLint *params))GPA( "glMaterialiv" );
	qglMatrixMode                =  dllMatrixMode                = (void (__stdcall *)(GLenum mode))GPA( "glMatrixMode" );
	qglMultMatrixd               =  dllMultMatrixd               = (void (__stdcall *)(const GLdouble *m))GPA( "glMultMatrixd" );
	qglMultMatrixf               =  dllMultMatrixf               = (void (__stdcall *)(const GLfloat *m))GPA( "glMultMatrixf" );
	qglNewList                   =  dllNewList                   = (void (__stdcall *)(GLuint list, GLenum mode))GPA( "glNewList" );
	qglNormal3b                  =  dllNormal3b                  = (void (__stdcall *)(GLbyte nx, GLbyte ny, GLbyte nz))GPA( "glNormal3b" );
	qglNormal3bv                 =  dllNormal3bv                 = (void (__stdcall *)(const GLbyte *v))GPA( "glNormal3bv" );
	qglNormal3d                  =  dllNormal3d                  = (void (__stdcall *)(GLdouble nx, GLdouble ny, GLdouble nz))GPA( "glNormal3d" );
	qglNormal3dv                 =  dllNormal3dv                 = (void (__stdcall *)(const GLdouble *v))GPA( "glNormal3dv" );
	qglNormal3f                  =  dllNormal3f                  = (void (__stdcall *)(GLfloat nx, GLfloat ny, GLfloat nz))GPA( "glNormal3f" );
	qglNormal3fv                 =  dllNormal3fv                 = (void (__stdcall *)(const GLfloat *v))GPA( "glNormal3fv" );
	qglNormal3i                  =  dllNormal3i                  = (void (__stdcall *)(GLint nx, GLint ny, GLint nz))GPA( "glNormal3i" );
	qglNormal3iv                 =  dllNormal3iv                 = (void (__stdcall *)(const GLint *v))GPA( "glNormal3iv" );
	qglNormal3s                  =  dllNormal3s                  = (void (__stdcall *)(GLshort nx, GLshort ny, GLshort nz))GPA( "glNormal3s" );
	qglNormal3sv                 =  dllNormal3sv                 = (void (__stdcall *)(const GLshort *v))GPA( "glNormal3sv" );
	qglNormalPointer             =  dllNormalPointer             = (void (__stdcall *)(GLenum type, GLsizei stride, const GLvoid *pointer))GPA( "glNormalPointer" );
	qglOrtho                     =  dllOrtho                     = (void (__stdcall *)(GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble zNear, GLdouble zFar))GPA( "glOrtho" );
	qglPassThrough               =  dllPassThrough               = (void (__stdcall *)(GLfloat token))GPA( "glPassThrough" );
	qglPixelMapfv                =  dllPixelMapfv                = (void (__stdcall *)(GLenum map, GLsizei mapsize, const GLfloat *values))GPA( "glPixelMapfv" );
	qglPixelMapuiv               =  dllPixelMapuiv               = (void (__stdcall *)(GLenum map, GLsizei mapsize, const GLuint *values))GPA( "glPixelMapuiv" );
	qglPixelMapusv               =  dllPixelMapusv               = (void (__stdcall *)(GLenum map, GLsizei mapsize, const GLushort *values))GPA( "glPixelMapusv" );
	qglPixelStoref               =  dllPixelStoref               = (void (__stdcall *)(GLenum pname, GLfloat param))GPA( "glPixelStoref" );
	qglPixelStorei               =  dllPixelStorei               = (void (__stdcall *)(GLenum pname, GLint param))GPA( "glPixelStorei" );
	qglPixelTransferf            =  dllPixelTransferf            = (void (__stdcall *)(GLenum pname, GLfloat param))GPA( "glPixelTransferf" );
	qglPixelTransferi            =  dllPixelTransferi            = (void (__stdcall *)(GLenum pname, GLint param))GPA( "glPixelTransferi" );
	qglPixelZoom                 =  dllPixelZoom                 = (void (__stdcall *)(GLfloat xfactor, GLfloat yfactor))GPA( "glPixelZoom" );
	qglPointSize                 =  dllPointSize                 = (void (__stdcall *)(GLfloat size))GPA( "glPointSize" );
	qglPolygonMode               =  dllPolygonMode               = (void (__stdcall *)(GLenum face, GLenum mode))GPA( "glPolygonMode" );
	qglPolygonOffset             =  dllPolygonOffset             = (void (__stdcall *)(GLfloat factor, GLfloat units))GPA( "glPolygonOffset" );
	qglPolygonStipple            =  dllPolygonStipple            = (void (__stdcall *)(const GLubyte *mask))GPA( "glPolygonStipple" );
	qglPopAttrib                 =  dllPopAttrib                 = (void (__stdcall *)())GPA( "glPopAttrib" );
	qglPopClientAttrib           =  dllPopClientAttrib           = (void (__stdcall *)())GPA( "glPopClientAttrib" );
	qglPopMatrix                 =  dllPopMatrix                 = (void (__stdcall *)())GPA( "glPopMatrix" );
	qglPopName                   =  dllPopName                   = (void (__stdcall *)())GPA( "glPopName" );
	qglPrioritizeTextures        =  dllPrioritizeTextures        = (void (__stdcall *)(GLsizei n, const GLuint *textures, const GLclampf *priorities))GPA( "glPrioritizeTextures" );
	qglPushAttrib                =  dllPushAttrib                = (void (__stdcall *)(GLbitfield mask))GPA( "glPushAttrib" );
	qglPushClientAttrib          =  dllPushClientAttrib          = (void (__stdcall *)(GLbitfield mask))GPA( "glPushClientAttrib" );
	qglPushMatrix                =  dllPushMatrix                = (void (__stdcall *)())GPA( "glPushMatrix" );
	qglPushName                  =  dllPushName                  = (void (__stdcall *)(GLuint name))GPA( "glPushName" );
	qglRasterPos2d               =  dllRasterPos2d               = (void (__stdcall *)(GLdouble x, GLdouble y))GPA( "glRasterPos2d" );
	qglRasterPos2dv              =  dllRasterPos2dv              = (void (__stdcall *)(const GLdouble *v))GPA( "glRasterPos2dv" );
	qglRasterPos2f               =  dllRasterPos2f               = (void (__stdcall *)(GLfloat x, GLfloat y))GPA( "glRasterPos2f" );
	qglRasterPos2fv              =  dllRasterPos2fv              = (void (__stdcall *)(const GLfloat *v))GPA( "glRasterPos2fv" );
	qglRasterPos2i               =  dllRasterPos2i               = (void (__stdcall *)(GLint x, GLint y))GPA( "glRasterPos2i" );
	qglRasterPos2iv              =  dllRasterPos2iv              = (void (__stdcall *)(const GLint *v))GPA( "glRasterPos2iv" );
	qglRasterPos2s               =  dllRasterPos2s               = (void (__stdcall *)(GLshort x, GLshort y))GPA( "glRasterPos2s" );
	qglRasterPos2sv              =  dllRasterPos2sv              = (void (__stdcall *)(const GLshort *v))GPA( "glRasterPos2sv" );
	qglRasterPos3d               =  dllRasterPos3d               = (void (__stdcall *)(GLdouble x, GLdouble y, GLdouble z))GPA( "glRasterPos3d" );
	qglRasterPos3dv              =  dllRasterPos3dv              = (void (__stdcall *)(const GLdouble *v))GPA( "glRasterPos3dv" );
	qglRasterPos3f               =  dllRasterPos3f               = (void (__stdcall *)(GLfloat x, GLfloat y, GLfloat z))GPA( "glRasterPos3f" );
	qglRasterPos3fv              =  dllRasterPos3fv              = (void (__stdcall *)(const GLfloat *v))GPA( "glRasterPos3fv" );
	qglRasterPos3i               =  dllRasterPos3i               = (void (__stdcall *)(GLint x, GLint y, GLint z))GPA( "glRasterPos3i" );
	...
	qglTexCoord3sv               =  dllTexCoord3sv               = (void (__stdcall *)(const GLshort *v))GPA( "glTexCoord3sv" );
	qglTexCoord4d                =  dllTexCoord4d                = (void (__stdcall *)(GLdouble s, GLdouble t, GLdouble r, GLdouble q))GPA( "glTexCoord4d" );
	qglTexCoord4dv               =  dllTexCoord4dv               = (void (__stdcall *)(const GLdouble * v))GPA( "glTexCoord4dv" );
	qglTexCoord4f                =  dllTexCoord4f                = (void (__stdcall *)(GLfloat s, GLfloat t, GLfloat r, GLfloat q))GPA( "glTexCoord4f" );
	qglTexCoord4fv               =  dllTexCoord4fv               = (void (__stdcall *)(const GLfloat * v))GPA( "glTexCoord4fv" );
	qglTexCoord4i                =  dllTexCoord4i                = (void (__stdcall *)(GLint s, GLint t, GLint r, GLint q))GPA( "glTexCoord4i" );
	qglTexCoord4iv               =  dllTexCoord4iv               = (void (__stdcall *)(const GLint *v))GPA( "glTexCoord4iv" );
	qglTexCoord4s                =  dllTexCoord4s                = (void (__stdcall *)(GLshort s, GLshort t, GLshort r, GLshort q))GPA( "glTexCoord4s" );
	qglTexCoord4sv               =  dllTexCoord4sv               = (void (__stdcall *)(const GLshort *v))GPA( "glTexCoord4sv" );
	qglTexCoordPointer           =  dllTexCoordPointer           = (void (__stdcall *)(GLint size, GLenum type, GLsizei stride, const GLvoid *pointer))GPA( "glTexCoordPointer" );
	qglTexEnvf                   =  dllTexEnvf                   = (void (__stdcall *)(GLenum target, GLenum pname, GLfloat param))GPA( "glTexEnvf" );
	qglTexEnvfv                  =  dllTexEnvfv                  = (void (__stdcall *)(GLenum target, GLenum pname, const GLfloat *params))GPA( "glTexEnvfv" );
	qglTexEnvi                   =  dllTexEnvi                   = (void (__stdcall *)(GLenum target, GLenum pname, GLint param))GPA( "glTexEnvi" );
	qglTexEnviv                  =  dllTexEnviv                  = (void (__stdcall *)(GLenum target, GLenum pname, const GLint *params))GPA( "glTexEnviv" );
	qglTexGend                   =  dllTexGend                   = (void (__stdcall *)(GLenum coord, GLenum pname, GLdouble param))GPA( "glTexGend" );
	qglTexGendv                  =  dllTexGendv                  = (void (__stdcall *)(GLenum coord, GLenum pname, const GLdouble *params))GPA( "glTexGendv" );
	qglTexGenf                   =  dllTexGenf                   = (void (__stdcall *)(GLenum coord, GLenum pname, GLfloat param))GPA( "glTexGenf" );
	qglTexGenfv                  =  dllTexGenfv                  = (void (__stdcall *)(GLenum coord, GLenum pname, const GLfloat *params))GPA( "glTexGenfv" );
	qglTexGeni                   =  dllTexGeni                   = (void (__stdcall *)(GLenum coord, GLenum pname, GLint param))GPA( "glTexGeni" );
	qglTexGeniv                  =  dllTexGeniv                  = (void (__stdcall *)(GLenum coord, GLenum pname, const GLint *params))GPA( "glTexGeniv" );
	qglTexImage1D                =  dllTexImage1D                = (void (__stdcall *)(GLenum target, GLint level, GLint internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const GLvoid *pixels))GPA( "glTexImage1D" );
	qglTexImage2D                =  dllTexImage2D                = (void (__stdcall *)(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels))GPA( "glTexImage2D" );
	qglTexParameterf             =  dllTexParameterf             = (void (__stdcall *)(GLenum target, GLenum pname, GLfloat param))GPA( "glTexParameterf" );
	qglTexParameterfv            =  dllTexParameterfv            = (void (__stdcall *)(GLenum target, GLenum pname, const GLfloat *params))GPA( "glTexParameterfv" );
	qglTexParameteri             =  dllTexParameteri             = (void (__stdcall *)(GLenum target, GLenum pname, GLint param))GPA( "glTexParameteri" );
	qglTexParameteriv            =  dllTexParameteriv            = (void (__stdcall *)(GLenum target, GLenum pname, const GLint *params))GPA( "glTexParameteriv" );
	qglTexSubImage1D             =  dllTexSubImage1D             = (void (__stdcall *)(GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const GLvoid *pixels))GPA( "glTexSubImage1D" );
	qglTexSubImage2D             =  dllTexSubImage2D             = (void (__stdcall *)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *pixels))GPA( "glTexSubImage2D" );
	qglTranslated                =  dllTranslated                = (void (__stdcall *)(GLdouble x, GLdouble y, GLdouble z))GPA( "glTranslated" );
	qglTranslatef                =  dllTranslatef                = (void (__stdcall *)(GLfloat x, GLfloat y, GLfloat z))GPA( "glTranslatef" );
	qglVertex2d                  =  dllVertex2d                  = (void (__stdcall *)(GLdouble x, GLdouble y))GPA( "glVertex2d" );
	qglVertex2dv                 =  dllVertex2dv                 = (void (__stdcall *)(const GLdouble *v))GPA( "glVertex2dv" );
	qglVertex2f                  =  dllVertex2f                  = (void (__stdcall *)(GLfloat x, GLfloat y))GPA( "glVertex2f" );
	qglVertex2fv                 =  dllVertex2fv                 = (void (__stdcall *)(const GLfloat *v))GPA( "glVertex2fv" );
	qglVertex2i                  =  dllVertex2i                  = (void (__stdcall *)(GLint x, GLint y))GPA( "glVertex2i" );
	qglVertex2iv                 =  dllVertex2iv                 = (void (__stdcall *)(const GLint *v))GPA( "glVertex2iv" );
	qglVertex2s                  =  dllVertex2s                  = (void (__stdcall *)(GLshort x, GLshort y))GPA( "glVertex2s" );
	qglVertex2sv                 =  dllVertex2sv                 = (void (__stdcall *)(const GLshort *v))GPA( "glVertex2sv" );
	qglVertex3d                  =  dllVertex3d                  = (void (__stdcall *)(GLdouble x, GLdouble y, GLdouble z))GPA( "glVertex3d" );
	qglVertex3dv                 =  dllVertex3dv                 = (void (__stdcall *)(const GLdouble *v))GPA( "glVertex3dv" );
	qglVertex3f                  =  dllVertex3f                  = (void (__stdcall *)(GLfloat x, GLfloat y, GLfloat z))GPA( "glVertex3f" );
	qglVertex3fv                 =  dllVertex3fv                 = (void (__stdcall *)(const GLfloat *v))GPA( "glVertex3fv" );
	qglVertex3i                  =  dllVertex3i                  = (void (__stdcall *)(GLint x, GLint y, GLint z))GPA( "glVertex3i" );
	qglVertex3iv                 =  dllVertex3iv                 = (void (__stdcall *)(const GLint *v))GPA( "glVertex3iv" );
	qglVertex3s                  =  dllVertex3s                  = (void (__stdcall *)(GLshort x, GLshort y, GLshort z))GPA( "glVertex3s" );
	qglVertex3sv                 =  dllVertex3sv                 = (void (__stdcall *)(const GLshort *v))GPA( "glVertex3sv" );
	qglVertex4d                  =  dllVertex4d                  = (void (__stdcall *)(GLdouble x, GLdouble y, GLdouble z, GLdouble w))GPA( "glVertex4d" );
	qglVertex4dv                 =  dllVertex4dv                 = (void (__stdcall *)(const GLdouble *v))GPA( "glVertex4dv" );
	qglVertex4f                  =  dllVertex4f                  = (void (__stdcall *)(GLfloat x, GLfloat y, GLfloat z, GLfloat w))GPA( "glVertex4f" );
	qglVertex4fv                 =  dllVertex4fv                 = (void (__stdcall *)(const GLfloat *v))GPA( "glVertex4fv" );
	qglVertex4i                  =  dllVertex4i                  = (void (__stdcall *)(GLint x, GLint y, GLint z, GLint w))GPA( "glVertex4i" );
	qglVertex4iv                 =  dllVertex4iv                 = (void (__stdcall *)(const GLint *v))GPA( "glVertex4iv" );
	qglVertex4s                  =  dllVertex4s                  = (void (__stdcall *)(GLshort x, GLshort y, GLshort z, GLshort w))GPA( "glVertex4s" );
	qglVertex4sv                 =  dllVertex4sv                 = (void (__stdcall *)(const GLshort *v))GPA( "glVertex4sv" );
	qglVertexPointer             =  dllVertexPointer             =(void (__stdcall *)(GLint size, GLenum type, GLsizei stride, const GLvoid *pointer)) GPA( "glVertexPointer" );
	qglViewport                  =  dllViewport                  = (void (__stdcall *)(GLint x, GLint y, GLsizei width, GLsizei height))GPA( "glViewport" );
	...
	qwglGetCurrentContext        = (HGLRC (__stdcall *)())GPA( "wglGetCurrentContext" );
	qwglGetCurrentDC             = (HDC (__stdcall *)())GPA( "wglGetCurrentDC" );
