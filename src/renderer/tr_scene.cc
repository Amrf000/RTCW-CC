...
void RE_RenderScene( const refdef_t *fd ) {
    ...
    VectorCopy( fd->vieworg, parms.orx.origin );
    VectorCopy( fd->viewaxis[0], parms.orx.axis[0] );
    VectorCopy( fd->viewaxis[1], parms.orx.axis[1] );
    VectorCopy( fd->viewaxis[2], parms.orx.axis[2] );
