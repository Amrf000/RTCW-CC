...
//----(SA)	done
	...
	if ( backEnd.viewParms.isPortal ) {
        ...
        plane2[0] = DotProduct( backEnd.viewParms.orx.axis[0], plane );
        plane2[1] = DotProduct( backEnd.viewParms.orx.axis[1], plane );
        plane2[2] = DotProduct( backEnd.viewParms.orx.axis[2], plane );
        plane2[3] = DotProduct( plane, backEnd.viewParms.orx.origin ) - plane[3];
...
//				tess.shaderTime = backEnd.refdef.floatTime - tess.shader->timeOffset;
                ...
                R_RotateForEntity( backEnd.currentEntity, &backEnd.viewParms, &backEnd.orx );

				// set up the dynamic lighting if needed
				if ( backEnd.currentEntity->needDlights ) {
                    R_TransformDlights( backEnd.refdef.num_dlights, backEnd.refdef.dlights, &backEnd.orx );
				}
                ...
                backEnd.orx = backEnd.viewParms.world;
...
//				tess.shaderTime = backEnd.refdef.floatTime - tess.shader->timeOffset;
            ...
            qglLoadMatrixf( backEnd.orx.modelMatrix );
