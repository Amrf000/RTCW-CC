...
cvarTable_t gameCvarTable[] = {
	...
	{ &g_gametype, "g_gametype", "5", CVAR_SERVERINFO | CVAR_LATCH, 0, false  },

	// Rafael gameskill
	{ &g_gameskill, "g_gameskill", "3", CVAR_SERVERINFO | CVAR_LATCH, 0, false  },
	// done

// JPW NERVE multiplayer stuffs
	{ &sv_screenshake, "sv_screenshake", "5", CVAR_ARCHIVE,0,false},
	...
	{ &g_LTChargeTime, "g_LTChargeTime", "40000", CVAR_SERVERINFO | CVAR_LATCH, 0, false },
	{ &g_soldierChargeTime, "g_soldierChargeTime", "20000", CVAR_SERVERINFO | CVAR_LATCH, 0, false },
// jpw

	{ &g_maxclients, "sv_maxclients", "20", CVAR_SERVERINFO | CVAR_LATCH | CVAR_ARCHIVE, 0, false  },            // NERVE - SMF - made 20 from 8
	{ &g_maxGameClients, "g_maxGameClients", "0", CVAR_SERVERINFO | CVAR_LATCH | CVAR_ARCHIVE, 0, false  },
	{ &g_minGameClients, "g_minGameClients", "8", CVAR_SERVERINFO, 0, false  },                              // NERVE - SMF

	// change anytime vars
	{ &g_dmflags, "dmflags", "0", /*CVAR_SERVERINFO |*/ CVAR_ARCHIVE, 0, true  },
	{ &g_fraglimit, "fraglimit", "0", /*CVAR_SERVERINFO |*/ CVAR_ARCHIVE | CVAR_NORESTART, 0, true },
	...
	{ &g_friendlyFire, "g_friendlyFire", "1", CVAR_SERVERINFO | CVAR_ARCHIVE, 0, true  },
	...
	// NERVE - SMF
	{ &g_warmupLatch, "g_warmupLatch", "1", 0, 0, false },

	{ &g_nextTimeLimit, "g_nextTimeLimit", "0", CVAR_WOLFINFO, 0, false  },
	{ &g_currentRound, "g_currentRound", "0", CVAR_WOLFINFO, 0, false  },
	{ &g_altStopwatchMode, "g_altStopwatchMode", "0", CVAR_ARCHIVE, 0, true  },
	{ &g_gamestate, "gamestate", "-1", CVAR_WOLFINFO | CVAR_ROM, 0, false  },

	{ &g_noTeamSwitching, "g_noTeamSwitching", "0", CVAR_ARCHIVE, 0, true  },

	{ &g_showHeadshotRatio, "g_showHeadshotRatio", "0", 0, 0, false  },

	{ &g_userTimeLimit, "g_userTimeLimit", "0", 0, 0, false  },
	{ &g_userAlliedRespawnTime, "g_userAlliedRespawnTime", "0", 0, 0, false  },
	{ &g_userAxisRespawnTime, "g_userAxisRespawnTime", "0", 0, 0, false  },

	{ &g_swapteams, "g_swapteams", "0", CVAR_ROM, 0, false },
	// -NERVE - SMF

	{ &g_log, "g_log", "", CVAR_ARCHIVE, 0, false  },
	...
	{ &g_forcerespawn, "g_forcerespawn", "0", 0, 0, true },
	{ &g_inactivity, "g_inactivity", "0", 0, 0, true },
	{ &g_debugMove, "g_debugMove", "0", 0, 0, false },
	{ &g_debugDamage, "g_debugDamage", "0", CVAR_CHEAT, 0, false },
	{ &g_debugAlloc, "g_debugAlloc", "0", 0, 0, false },
	{ &g_debugBullets, "g_debugBullets", "0", CVAR_CHEAT, 0, false}, //----(SA)	added
	{ &g_motd, "g_motd", "", CVAR_ARCHIVE, 0, false },

	{ &g_podiumDist, "g_podiumDist", "80", 0, 0, false },
	{ &g_podiumDrop, "g_podiumDrop", "70", 0, 0, false },

	{ &g_voteFlags, "g_voteFlags", "255", CVAR_ARCHIVE | CVAR_SERVERINFO, 0, false },
	{ &g_listEntity, "g_listEntity", "0", 0, 0, false },

	{ &g_complaintlimit, "g_complaintlimit", "3", CVAR_ARCHIVE, 0, true},                        // DHM - Nerve
	{ &g_maxlives, "g_maxlives", "0", CVAR_ARCHIVE | CVAR_LATCH | CVAR_SERVERINFO, 0, true},     // DHM - Nerve
	{ &g_voiceChatsAllowed, "g_voiceChatsAllowed", "4", CVAR_ARCHIVE, 0, false},             // DHM - Nerve

	{ &g_alliedmaxlives, "g_alliedmaxlives", "0", CVAR_LATCH | CVAR_SERVERINFO, 0, true},      // Xian
	{ &g_axismaxlives, "g_axismaxlives", "0", CVAR_LATCH | CVAR_SERVERINFO, 0, true},      // Xian
	{ &g_fastres, "g_fastres", "0", CVAR_ARCHIVE, 0, true},                                  // Xian - Fast Medic Resing
	{ &g_fastResMsec, "g_fastResMsec", "1000", CVAR_ARCHIVE, 0, true},                                   // Xian - Fast Medic Resing
	{ &g_knifeonly, "g_knifeonly", "0", 0, 0, true},                                         // Xian - Fast Medic Resing
	{ &g_enforcemaxlives, "g_enforcemaxlives", "1", CVAR_ARCHIVE, 0, true},                              // Xian - Gestapo enforce maxlives stuff by temp banning
	...
	{&mod_url, "mod_url", "", CVAR_SERVERINFO | CVAR_ROM, 0, false},
	// configured by the server admin, points to the web pages for the server
	{&url, "URL", "", CVAR_SERVERINFO | CVAR_ARCHIVE, 0, false},

	{&g_antilag, "g_antilag", "0", CVAR_SERVERINFO | CVAR_ARCHIVE, 0, false},

	{&g_dbgRevive, "g_dbgRevive", "0", 0, 0, false}
};
