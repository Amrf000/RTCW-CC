...
extern void G_SayTo( gentity_t *ent, gentity_t *other, int mode, int color, const char *name, const char *message, bool localize );
...
void Weapon_Gauntlet( gentity_t *ent ) {
	...
	if ( ( tr = CheckMeleeAttack( ent, 32, false ) ) ) {
